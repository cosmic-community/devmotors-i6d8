  ...
  if (!profile) {
    return (
      <section className="container mx-auto px-4 py-20 text-center">
        <h1 className="text-5xl font-bold">Welcome to Devmotors</h1>
        <p className="mt-4 text-muted">No profile available yet.</p>
      </section>
    );
  }
            ...
            {photo && (
              <div className="relative">
                ...
                <img
                  ...
                  width={400}
                  height={400}
                  className="relative w-64 h-64 md:w-80 md:h-80 rounded-full object-cover border-4 border-border"
                />
              </div>
            )}
          </div>
